...
public class Constants {
	public static class EnemyConstants {
		...
		public static final int ROBOT_WIDTH_DEFAULT = 72;
		...
		public static final int ROBOT_DRAWOFFSET_X = (int) (26 * Game.SCALE);
		public static final int ROBOT_DRAWOFFSET_Y = (int) (9 * Game.SCALE);
